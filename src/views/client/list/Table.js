      ...
      <Col sm="12" className='d-flex align-items-center py-1 px-0 mb-1'>
        ...
        <Col xl='6' className='d-flex align-items-center p-0'>
          <div className='d-flex align-items-center w-100'>
            ...
            <div className="ms-2">
              ...
              {/* <span role="button" className="mx-1 px-4 py-1 border-1 border-secondary rounded"></span> */}
            </div>
          </div>
        </Col>
        <Col
        ...
        >
          ...
          <div className='d-flex align-items-center table-header-actions'>
            ...
            <span onClick={() => history.push("/team/clients/add")} style={{ width: 'max-content' }} className='align-middle btn btn-primary'>Add New Client</span>
            {/* </DropdownToggle> */}
          </div>
        </Col>
      </Row>
