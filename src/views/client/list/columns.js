...
export const columns = [
  ...
  },
  {
    ...
    cell: (row) => (
        <>
            {row.classification === '1' && <span className='text-capitalize font-weight-bold text-warning px-1 bg-light rounded'>{'Gold'}</span>}
            {row.classification === '2' && <span className='text-capitalize font-weight-bold text-secondary px-1 bg-light rounded'>{'Silver'}</span>}
        </>
        )
  },
  {
  ...
  },
  {
    ...
    cell: (row) => (
        <>
            {row.status === '1' && <span className='text-capitalize font-weight-bold text-danger px-0 bg-light rounded'>{'Inactive'}</span>}
            {row.status === '2' && <span className='text-capitalize font-weight-bold text-success px-0 bg-light rounded'>{'Paid'}</span>}
            {row.status === '3' && <span className='text-capitalize font-weight-bold text-primary px-0 bg-light rounded'>{'Active'}</span>}
        </>
        )
  },
  {
