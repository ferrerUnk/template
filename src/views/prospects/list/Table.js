    ...
    <div className='invoice-list-table-header w-100 me-1 ms-50 mt-2 mb-75'>
      <Row>
        <Col sm="12" className='d-flex align-items-center py-1 px-0 mb-1'>
          <p className="h4 px-0">Prospects</p>
        </Col>
          ...
          <div className='d-flex align-items-center table-header-actions'>
            <UncontrolledDropdown className='me-1'>
              ...
              <DropdownMenu>
                ...
                <span onClick={() => history.push("/team/prospects/add")} style={{ width: 'max-content'}}className='align-middle btn btn-primary'>Add New Prospects</span>
              {/* </DropdownToggle> */}
          </div>
        </Col>
      </Row>
